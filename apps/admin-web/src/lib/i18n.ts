...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    manageRentalUnits: 'Manage rental offices and their availability',
    ...
    searchPlaceholder: 'Search contracts by tenant, office, status, amount...',
    ...
    searchUnits: 'Search offices by name, price, area, floor, status...',
    getStartedByCreatingUnit: 'Get started by creating your first office.',
    unitRecordsWillAppear: 'Office records will appear here once offices are created.',
    free: 'Free',
    busy: 'Busy',
    ...
    createFirstBuilding: 'Create your first building to organize offices',
    tryDifferentSearch: 'Try a different search term',
    totalBuildings: 'Total Buildings',
    totalUnits: 'Total Offices',
    occupied: 'Occupied',
    available: 'Available',
  ...
  ru: {
    ...
    manageRentalUnits: 'Управление офисами и их доступностью',
    ...
    searchUnits: 'Поиск офисов по названию, цене, площади, этажу, статусу...',
    getStartedByCreatingUnit: 'Начните с создания вашего первого офиса.',
    unitRecordsWillAppear: 'Записи офисов появятся здесь после создания офисов.',
    free: 'Свободна',
    busy: 'Занята',
  ...
  uz: {
    ...
    manageRentalUnits: 'Ijara ofislarini va ularning mavjudligini boshqarish',
    ...
    searchPlaceholder: 'Ijara oluvchi, ofis, holat, summa bo\'yicha qidirish...',
    ...
    searchUnits: 'Nomi, narxi, maydoni, qavati, holati bo\'yicha ofislarni qidirish...',
    getStartedByCreatingUnit: 'Birinchi ofisni yaratishdan boshlang.',
    unitRecordsWillAppear: 'Ofislar yaratilgandan keyin yozuvlar bu yerda paydo bo\'ladi.',
    free: 'Bo\'sh',
    busy: 'Band',
    ...
    createFirstBuilding: 'Ofislarni tashkil qilish uchun birinchi binoni yarating',
    tryDifferentSearch: 'Boshqa qidiruv so\'rovini sinab ko\'ring',
    totalBuildings: 'Jami binolar',
    totalUnits: 'Jami ofislar',
    occupied: 'Band',
    available: 'Mavjud',
