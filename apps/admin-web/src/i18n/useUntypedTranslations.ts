...
export function useUntypedTranslations(): Record<string, string> {
  return {
    ...
    emailAndPasswordRequired: 'Email va parol talab qilinadi',
    ...
    never: 'Hech qachon',
    backToTop: 'Yuqoriga',
    conversationClosed: 'Bu suhbat yopilgan',
    typeMessagePlaceholder: 'Xabar yozing...',
    searchByTenantInvoice: 'Ijara oluvchi, hisob-faktura, summa, holat bo\'yicha qidirish...',
    ...
    deleteInvoiceWarning: 'Bu hisob-fakturani o\'chirishni xohlaysizmi? Bu amalni bekor qilib bo\'lmaydi. Unga bog\'liq kutilayotgan to\'lovlar ham o\'chiriladi.',
    selectContract: 'Shartnomani tanlang',
    unknownUser: 'Noma\'lum',
    noUnit: 'Xona yo\'q',
    enterMonthlyRent: 'Oylik ijara summasini kiriting',
    changeStatus: 'Holatni o\'zgartirish',
    createContract: 'Shartnoma yaratish',
    activityLogs: 'Faollik jurnali',
    clearFilters: 'Filtrlarni tozalash',
    ...
    createUser: 'Foydalanuvchi yaratish',
    tenantsList: 'Ijara oluvchilar ro\'yxati',
    manageTenantAccounts: 'Ijara oluvchi hisoblarini boshqarish',
    createTenant: 'Ijara oluvchi yaratish',
    contractsList: 'Shartnomalar ro\'yxati',
    manageRentalContracts: 'Ijara shartnomalarini boshqarish',
    noContracts: 'Shartnomalar yo\'q',
    monthlyRent: 'Oylik ijara',
    totalContractAmount: 'Shartnomaning umumiy summasi',
    untitledConversation: 'Mavzusiz suhbat',
    searchLogs: 'Jurnallarni qidirish...',
    allActions: 'Barcha harakatlar',
    logsFound: 'jurnal topildi',
    noLogs: 'Faollik jurnali yo\'q',
    searchByEmailUnit: 'Email yoki xona nomi bo\'yicha qidirish...',
    searchByNameEmail: 'Ism, email bo\'yicha qidirish...',
    typeMessageHere: 'Xabaringizni shu yerga yozing... (HTML qo\'llab-quvvatlanadi)',
    typeBroadcastMessage: 'E\'lon xabarini shu yerga yozing... (HTML qo\'llab-quvvatlanadi)',
    userManager: 'Foydalanuvchi menejeri',
    paymentCollector: 'To\'lov yig\'uvchi',
    contract: 'Shartnoma',
    payments: 'To\'lovlar',
    viewAndManagePayments: 'To\'lov yozuvlarini ko\'rish va boshqarish',
    updating: 'Yangilanmoqda...',
    deleting: 'O\'chirilmoqda...',
    cancelPaymentWarning: 'To\'lovni bekor qilish hisob-faktura holatiga ta\'sir qilmaydi. Hisob-faktura to\'lanmagan bo\'lib qoladi.',
