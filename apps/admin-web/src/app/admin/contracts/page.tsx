...
export default function AdminContractsPage() {
  ...
  return (
      ...
      {/* Search and Filter Bar - always show so user can change filter when list is empty due to filters */}
                            ...
                            <>
                              ...
                              {getAvailableStatuses(contract.status).length > 0 && (
                                <button
                                  ...
                                  onClick={() => openStatusModal(contract)}
                                  className={`px-2 py-1 rounded text-xs font-medium transition-colors ${
                                    darkMode ? 'text-yellow-400 hover:bg-yellow-600/20' : 'text-yellow-600 hover:bg-yellow-100'
                                  }`}
                                  title={t.changeStatus || 'Holatni o\'zgartirish'}
                                >
                              ...
                              <button
                                ...
                                className={`px-2 py-1 rounded text-xs font-medium transition-colors disabled:opacity-50 ${
                                  darkMode ? 'text-orange-400 hover:bg-orange-600/20' : 'text-orange-600 hover:bg-orange-100'
                                }`}
                                title={t.archive || 'Arxivlash'}
                              >
