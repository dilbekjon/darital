                          ...
                          {openDropdownId === contract.id && (
                            <>
                              ...
                              <div 
                                ...
                                style={{
                                  scrollbarWidth: 'thin',
                                  scrollbarColor: darkMode ? '#333 #1a1a1a' : '#ccc #f1f1f1'
                                }}
                              >
                                <a
                                  href={contract.pdfUrl}
                                ...
                                >
                                  ...
                                  <span className="truncate">{t.viewPDF || 'PDF ni ko\'rish'}</span>
                                </a>
                                ...
                                {canUpdateContracts && (
                                  <>
                                    ...
                                    >
                                      ...
                                      <span className="truncate">{t.edit || 'Tahrirlash'}</span>
                                    </button>
                                    ...
                                    {getAvailableStatuses(contract.status).length > 0 && (
                                      ...
                                      >
                                        ...
                                        <span className="truncate">{t.changeStatus || 'Holatni o\'zgartirish'}</span>
                                      </button>
                                    )}
                                    ...
                                    >
                                      ...
                                      <span className="truncate">{archivingContractId === contract.id ? (t.loading || 'Yuklanmoqda...') : (t.archive || 'Arxivlash')}</span>
                                    </button>
                                  </>
                                )}
                                ...
                                {canDeleteContracts && (
                                  <>
                                    ...
                                    >
                                      ...
                                      <span className="truncate">{t.delete || 'O\'chirish'}</span>
                                    </button>
                                  </>
                                )}
                              </div>
