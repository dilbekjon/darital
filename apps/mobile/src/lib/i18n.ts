// O'zbek tilidagi matnlar (Uzbek only)
...
export interface Translations {
  ...
  contract: string;
  viewPayments: string;
  setUpPasscode: string;
  noContractPdf: string;
...
export const t: Translations = {
  ...
  preferencesSaved: 'Saqlandi',
  saveChanges: 'Saqlash',
  receipt: 'Kvitansiya',
  more: 'Boshqa',
  paymentFailed: 'To\'lov amalga oshmadi',
  notificationPreferences: 'Bildirishnomalar',
  ...
  setUpPasscode: 'Kod-parol o\'rnatish',
  noContractPdf: 'Shartnoma PDF mavjud emas',
  couldNotOpenPdf: 'PDF ochilmadi',
  tenant: 'Ijarachi',
};
