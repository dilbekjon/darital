    ...
    try {
      ...
      const tenant = await this.prisma.tenant.create({
        data: {
          ...
          passwordSetAt: null,
          utilityElectricityEnabled: dto.utilityElectricityEnabled ?? true,
          utilityGasEnabled: dto.utilityGasEnabled ?? false,
          utilityWaterEnabled: dto.utilityWaterEnabled ?? false,
        },
      });
